...
void Menu::Options(const DessinFond& fond) {
    Liste liste(app, 112.f, 34.f, 20, 640.f);
    ...
    while (app.fenetre.isOpen()) {
        ...
        while (app.fenetre.pollEvent(evenement)) {
            ...
            switch (liste.Selection()) {
                ...
                case 5: r.mouvementsFluides = !r.mouvementsFluides; break;
                case 6: r.effets = !r.effets; break;
                case 7: r.secousses = !r.secousses; break;
                case 8:
        ...
        liste.Definir({
            ...
            Utf8("Mouvements fluides : ") + OuiNon(r.mouvementsFluides),
            Utf8("Effets visuels : ") + OuiNon(r.effets),
            Utf8("Secousses du plateau : ") + OuiNon(r.secousses),
            Utf8("Synchro verticale : ") + OuiNon(r.synchroVerticale),
        ...
        app.fenetre.clear(COULEUR_FOND);
        fond();
        DessinerTexte(Utf8("Options"), 40, 55.f);
        liste.Dessiner(texte);
